...
EN = {
 ...
 "응답자키":"respondent_key","학교키":"school_key","원변수명":"source_var","값":"value","결측보정":"missing_fix",
...
DESC = {
 ...
 "응답자키":"원본 식별자를 치환한 대체키. 집계에 사용하지 않음. 주기 내에서만 유효하며 "
          "동일 주기의 학생·학부모는 같은 키로 연결됨. 주기가 다르면 서로 다른 사람",
 "학교키":"원본 학교코드를 치환한 대체키. 주기 무관하게 동일 학교에 동일 키",
